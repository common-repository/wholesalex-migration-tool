 ...
 * @since 1.0.0
 */
class WholesaleX_B2BKing_Background_Migration extends WC_Background_Process {

    public function __construct()
    {
        $this->prefix ='wholesalex_'.get_current_blog_id(  );
        $this->action = 'wholesalex_b2bking_migration';
	...
	protected function task( $item ) {
		set_transient('wholesalex_b2bking_migrating',true);
		...
		$migration_data = get_transient('wholesalex_b2bking_migration_stats');
		...
		set_transient('wholesalex_b2bking_migration_stats',$migration_data);
	...
	protected function complete() {
		...
		wholesalex()->set_setting('b2bking_migration_complete',true);
		parent::complete();
	}
